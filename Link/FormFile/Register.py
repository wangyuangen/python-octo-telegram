...
#
# Created: Mon May 28 10:05:22 2018
...
class Ui_register_2(QtGui.QMainWindow):
    ...
    def setupUi(self, register_2):
        ...
        self.le_custName = QtGui.QLineEdit(register_2)
        self.le_custName.setGeometry(QtCore.QRect(120, 60, 113, 20))
        self.le_custName.setObjectName(_fromUtf8("le_custName"))
